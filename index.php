...
echo '<link';
echo 'rel="stylesheet"';
echo 'href="https://cdnjs.cloudflare.com/ajax/libs/bulma/0.9.4/css/bulma.min.css"';
echo 'integrity="sha512-HqxHUkJM0SYcbvxUw5P60SzdOTy/QVwA1JJrvaXJv4q7lmbDZCmZaqz01UPOaQveoxfYRv1tHozWGPMcuTBuvQ=="';
...
echo '<link';
echo 'href="https://fonts.googleapis.com/css2?family=Kanit:wght@300&display=swap"';
echo 'rel="stylesheet"';
echo '/>';
echo '<link rel="preconnect" href="https://fonts.googleapis.com" />';
echo '<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />';
echo '<link';
echo 'href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300&display=swap"';
echo 'rel="stylesheet"';
echo '/>';
echo '<link href="https://fonts.googleapis.com/css2?family=Fasthand&display=swap" rel="stylesheet">';
echo '<script src="index.js" defer></script>';
echo '<title>Portfolio Site</title>';
echo '</head>';
echo '<body>';
echo '<div id="modal">';
echo '';
echo '<div class="is-flex is-flex-direction-column" id="modal-content">';
echo '<a download href="/JustinFlanaganResume (2).docx"  class="modal-links pt-4">';
echo 'Resume';
echo '</a>';
echo '<a';
echo 'href="https://www.linkedin.com/in/justin-flan"';
echo 'target="_blank"';
echo 'id="linked-in"';
echo '>';
echo 'LinkedIn';
echo '</a>';
echo '<a';
echo 'href="https://github.com/jflanagan55"';
echo 'id="github"';
echo 'target="_blank"';
echo '>';
echo 'GitHub';
echo '</a>';
echo '<a href="#skills-section" class="modal-links">About</a>';
echo '<a href="#projects-section"class="modal-links">Projects</a>';
echo '<a href="#message-section" class="modal-links pb-4">Contact</span></a>';
echo '</div>';
echo '</div>';
echo '<nav class="p-3">';
echo '<div class="pl-5" id="nav-info">';
echo '<a href="#skills-section" class="pr-2"> <span>About</span></a>';
echo '<a href="#projects-section" class="px-2"> <span>Projects</span></a>';
echo '<a href="#message-section" class="pl-2"> <span>Contact</span></a>';
echo '</div>';
echo '<div>';
echo '<a href="">';
echo '<h2 id="justin-flanagan">Justin Flanagan</h2>';
echo '</a>';
echo '</div>';
echo '<div class="pr-5" id="social">';
echo '<a download href="/JustinFlanaganResume (2).docx" class="pr-2">';
echo 'Resume';
echo '</a>';
echo '<a';
echo 'href="https://www.linkedin.com/in/justin-flan"';
...
echo '</a>';
echo '</div>';
echo '<div id="mobile-only">';
echo '<div id="jf" class="pl-4"><a href="">JF</a></div>';
echo '<div id="hamburger" class="pr-4">';
...
echo '</nav>';
echo '<section';
echo 'id="first-section"';
echo 'class="section is-medium is-flex is-align-items-center is-flex-direction-column"';
echo '>';
echo '<div>';
echo '<p>Justin Flanagan</p>';
echo '<p>Data Analyst & Front End Developer</p>';
echo '</div>';
echo '</section>';
echo '';
echo '<main>';
echo '<section id="skills-section" class="py-6">';
echo '<h2>A Little About Me</h2>';
echo '<h3 class="py-6"><span>Proficiencies</span></h3>';
echo '<div class="icon-container">';
echo '<svg';
echo 'xmlns="http://www.w3.org/2000/svg"';
echo 'viewBox="0 0 48 48"';
echo 'width="144px"';
echo 'height="144px"';
echo '>';
echo '<path fill="#E65100" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z" />';
echo '<path fill="#FF6D00" d="M24 8L24 39.9 35.2 36.7 37.7 8z" />';
echo '<path';
echo 'fill="#FFF"';
echo 'd="M24,25v-4h8.6l-0.7,11.5L24,35.1v-4.2l4.1-1.4l0.3-4.5H24z M32.9,17l0.3-4H24v4H32.9z"';
echo '/>';
echo '<path';
echo 'fill="#EEE"';
echo 'd="M24,30.9v4.2l-7.9-2.6L15.7,27h4l0.2,2.5L24,30.9z M19.1,17H24v-4h-9.1l0.7,12H24v-4h-4.6L19.1,17z"';
echo '/>';
echo '</svg>';
echo '<svg';
echo 'xmlns="http://www.w3.org/2000/svg"';
...
echo 'height="144px"';
echo '>';
echo '<path fill="#0277BD" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z" />';
echo '<path fill="#039BE5" d="M24 8L24 39.9 35.2 36.7 37.7 8z" />';
echo '<path';
echo 'fill="#FFF"';
echo 'd="M33.1 13L24 13 24 17 28.9 17 28.6 21 24 21 24 25 28.4 25 28.1 29.5 24 30.9 24 35.1 31.9 32.5 32.6 21 32.6 21z"';
echo '/>';
echo '<path';
echo 'fill="#EEE"';
echo 'd="M24,13v4h-8.9l-0.3-4H24z M19.4,21l0.2,4H24v-4H19.4z M19.8,27h-4l0.3,5.5l7.9,2.6v-4.2l-4.1-1.4L19.8,27z"';
echo '/>';
echo '</svg>';
echo '<svg';
echo 'xmlns="http://www.w3.org/2000/svg"';
...
echo '<path';
echo 'fill="#F4511E"';
echo 'd="M42.2,22.1L25.9,5.8C25.4,5.3,24.7,5,24,5c0,0,0,0,0,0c-0.7,0-1.4,0.3-1.9,0.8l-3.5,3.5l4.1,4.1c0.4-0.2,0.8-0.3,1.3-0.3c1.7,0,3,1.3,3,3c0,0.5-0.1,0.9-0.3,1.3l4,4c0.4-0.2,0.8-0.3,1.3-0.3c1.7,0,3,1.3,3,3s-1.3,3-3,3c-1.7,0-3-1.3-3-3c0-0.5,0.1-0.9,0.3-1.3l-4-4c-0.1,0-0.2,0.1-0.3,0.1v10.4c1.2,0.4,2,1.5,2,2.8c0,1.7-1.3,3-3,3s-3-1.3-3-3c0-1.3,0.8-2.4,2-2.8V18.8c-1.2-0.4-2-1.5-2-2.8c0-0.5,0.1-0.9,0.3-1.3l-4.1-4.1L5.8,22.1C5.3,22.6,5,23.3,5,24c0,0.7,0.3,1.4,0.8,1.9l16.3,16.3c0,0,0,0,0,0c0.5,0.5,1.2,0.8,1.9,0.8s1.4-0.3,1.9-0.8l16.3-16.3c0.5-0.5,0.8-1.2,0.8-1.9C43,23.3,42.7,22.6,42.2,22.1z"';
echo '/>';
echo '</svg>';
echo '</div>';
echo '<h3 class="py-6"><span>Competencies</span></h3>';
echo '<div class="icon-container">';
echo '<svg';
echo 'xmlns="http://www.w3.org/2000/svg"';
echo 'viewBox="0 0 48 48"';
...
echo '<path';
echo 'fill="#5d4037"';
echo 'd="M42,17.3C42,37.8,24,44,24,44S6,37.8,6,17.3c0-2.5,0.2-4.6,0.4-6.3c0.3-2.5,2-4.5,4.4-5.1 C13.9,5,18.8,4,24,4s10.1,1,13.3,1.9c2.4,0.6,4.1,2.7,4.4,5.1C41.8,12.7,42,14.9,42,17.3z"';
echo '/>';
echo '<path';
echo 'fill="#4caf50"';
echo 'd="M24,7c4.9,0,9.5,1,12.5,1.8c1.2,0.3,2,1.3,2.2,2.6c0.2,1.9,0.3,3.9,0.3,5.9c0,15.6-11.5,21.9-15,23.4 c-3.5-1.6-15-7.9-15-23.4c0-2,0.1-4,0.3-5.9c0.1-1.3,1-2.3,2.2-2.6C14.5,8,19.1,7,24,7 M24,4c-5.2,0-10.1,1-13.3,1.9 C8.4,6.5,6.6,8.6,6.4,11C6.2,12.7,6,14.9,6,17.3C6,37.8,24,44,24,44s18-6.2,18-26.7c0-2.5-0.2-4.6-0.4-6.3c-0.3-2.5-2-4.5-4.4-5.1 C34.1,5,29.2,4,24,4L24,4z"';
echo '/>';
echo '<path fill="#dcedc8" d="M23 28H25V36H23z" />';
echo '<path';
echo 'fill="#4caf50"';
echo 'd="M24,10c0,0-6,5-6,13c0,5.2,3.3,8.5,5,10l1-3l1,3c1.7-1.5,5-4.8,5-10C30,15,24,10,24,10z"';
echo '/>';
echo '<path';
echo 'fill="#81c784"';
echo 'd="M24,10c0,0-6,5-6,13c0,5.2,3.3,8.5,5,10l1-3V10z"';
echo '/>';
echo '</svg>';
echo '<svg';
echo 'xmlns="http://www.w3.org/2000/svg"';
echo 'viewBox="0 0 40 40"';
echo 'width="144px"';
echo 'height="144px"';
echo 'baseProfile="basic"';
echo '>';
...
echo '<path';
echo 'fill="#21a366"';
echo 'd="M24.007,45.419c-0.574,0-1.143-0.15-1.646-0.44l-5.24-3.103c-0.783-0.438-0.401-0.593-0.143-0.682 c1.044-0.365,1.255-0.448,2.369-1.081c0.117-0.067,0.27-0.043,0.39,0.028l4.026,2.389c0.145,0.079,0.352,0.079,0.486,0l15.697-9.061 c0.145-0.083,0.24-0.251,0.24-0.424V14.932c0-0.181-0.094-0.342-0.243-0.432L24.253,5.446c-0.145-0.086-0.338-0.086-0.483,0 L8.082,14.499c-0.152,0.086-0.249,0.255-0.249,0.428v18.114c0,0.173,0.094,0.338,0.244,0.42l4.299,2.483 c2.334,1.167,3.76-0.208,3.76-1.591V16.476c0-0.255,0.2-0.452,0.456-0.452h1.988c0.248,0,0.452,0.196,0.452,0.452v17.886 c0,3.112-1.697,4.9-4.648,4.9c-0.908,0-1.623,0-3.619-0.982l-4.118-2.373C5.629,35.317,5,34.216,5,33.042V14.928 c0-1.179,0.629-2.279,1.646-2.861L22.36,3.002c0.994-0.562,2.314-0.562,3.301,0l15.694,9.069C42.367,12.656,43,13.753,43,14.932 v18.114c0,1.175-0.633,2.271-1.646,2.861L25.66,44.971c-0.503,0.291-1.073,0.44-1.654,0.44"';
echo '/>';
echo '<path';
echo 'fill="#21a366"';
echo 'd="M28.856,32.937c-6.868,0-8.308-3.153-8.308-5.797c0-0.251,0.203-0.452,0.455-0.452h2.028 c0.224,0,0.413,0.163,0.448,0.384c0.306,2.066,1.218,3.108,5.371,3.108c3.308,0,4.715-0.747,4.715-2.502 c0-1.01-0.401-1.76-5.54-2.263c-4.299-0.424-6.955-1.371-6.955-4.809c0-3.167,2.672-5.053,7.147-5.053 c5.026,0,7.517,1.745,7.831,5.493c0.012,0.13-0.035,0.255-0.122,0.35c-0.086,0.09-0.208,0.145-0.334,0.145h-2.039 c-0.212,0-0.397-0.149-0.44-0.354c-0.491-2.173-1.678-2.868-4.904-2.868c-3.611,0-4.031,1.257-4.031,2.2 c0,1.143,0.495,1.477,5.367,2.122c4.825,0.64,7.116,1.544,7.116,4.935c0,3.418-2.853,5.379-7.827,5.379"';
echo '/>';
echo '</svg>';
echo '</div>';
echo '</section>';
echo '<section id="projects-section" class="section is-medium">';
echo '<div class="is-flex is-justify-content-center">';
echo '<div style="width: 400px">';
echo '<h2 id="projects-h2">Projects</h2>';
echo '<div id="projects-underline"></div>';
echo '</div>';
echo '</div>';
echo '';
echo '<div';
echo 'class="is-flex is-align-items-center is-flex-direction-column pt-6" id="projects-container"';
echo '>';
echo '<div class="box">';
echo '<div class="content">';
echo '<div class="is-flex is-justify-content-flex-start">';
echo '<figure>';
echo '<img';
echo 'src=https://images.unsplash.com/photo-1537047902294-62a40c20a6ae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80';
echo '/>';
echo '</figure>';
echo '</div>';
echo '<div class="is-flex is-justify-content-flex-start">';
echo '<div';
echo 'class="is-flex is-flex-direction-column is-justify-content-space-evenly"';
echo '>';
echo '<h3 class="project-titles">Restaurant Journal</h3>';
echo '<p class="has-text-centered pb-4">';
echo 'Simple CRUD application with user authentication that stores';
echo 'users reviews of restaurants. Made with Mongoose, Express,';
echo 'and Node.';
echo '</p>';
echo '<div class="button-container">';
echo '<a';
echo 'href="https://justin-flanagan-restaurants.herokuapp.com"';
echo 'class=" button is-rounded"';
echo 'target="_blank"';
echo '>Live Demo</a';
echo '>';
echo '<a';
echo 'href="https://github.com/jflanagan55/Restaurants"';
echo 'class="button is-rounded"';
echo 'target="_blank"';
echo '>Source Code</a';
echo '>';
...
echo 'class="is-flex is-flex-direction-column is-justify-content-space-evenly"';
echo '>';
echo '<h3 class="project-titles">Shoe Store</h3>';
echo '<p class="has-text-centered pb-4">';
echo 'Mock e-commerce shoe site with interactive cart and checkout';
echo 'form validation. Made with React, Redux, and Semantic UI.';
echo '</p>';
echo '<div class="button-container">';
echo '<a';
echo 'href="https://justin-flanagan-shoe-store.herokuapp.com/"';
echo 'class="button is-rounded"';
echo 'target="_blank"';
echo '>Live Demo</a';
echo '>';
echo '<a';
echo 'href="https://github.com/jflanagan55/eCommerce/"';
echo 'class="button is-rounded"';
echo 'target="_blank"';
echo '>Source Code</a';
echo '>';
...
echo '</div>';
echo '</div>';
echo '<div class="is-flex is-justify-content-flex-end">';
echo '<figure>';
echo '<img';
echo 'src="https://images.unsplash.com/photo-1603808033192-082d6919d3e1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=715&q=80"';
echo '/>';
echo '</figure>';
echo '</div>';
echo '</div>';
...
echo '<figure>';
echo '<img';
echo 'src="https://images.unsplash.com/photo-1587223962930-cb7f31384c19?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"';
echo '/>';
echo '</figure>';
echo '</div>';
echo '<div class="is-flex is-justify-content-flex-start">';
...
echo 'class="is-flex is-flex-direction-column is-justify-content-space-evenly"';
echo '>';
echo '<h3 class="project-titles">Cocktail Finder</h3>';
echo '<p class="has-text-centered pb-4">';
echo 'User Interface that connects to a cocktail api, takes user';
echo 'input, and displays information about a drink. Made with';
echo 'Javascipt and Bulma.';
echo '</p>';
echo '<div class="button-container">';
echo '<a';
echo 'href="https://justin-flanagan-cocktail.herokuapp.com/index.html"';
echo 'class= "button is-rounded"';
echo 'target="_blank"';
echo '>Live Demo</a';
echo '>';
echo '<a';
echo 'href="https://github.com/jflanagan55/CocktailAPI"';
echo 'class= "button is-rounded"';
echo 'target="_blank"';
echo '>Source Code</a';
echo '>';
...
echo 'class="is-flex is-flex-direction-column is-justify-content-space-evenly"';
echo '>';
echo '<h3 class="project-titles">Previous Site</h3>';
echo '<p class="has-text-centered pb-4">';
echo 'My first version of my portfolio site. Created using all of the same technologies as this current site.';
echo '</p>';
echo '<div class="button-container">';
echo '<a';
echo 'href="https://first-edition-site.herokuapp.com/"';
echo 'class="button is-rounded"';
echo 'target="_blank"';
echo '>Live Demo</a';
echo '>';
echo '<a';
echo 'href="https://github.com/jflanagan55/FirstEditionSite"';
echo 'class="button is-rounded"';
echo 'target="_blank"';
echo '>Source Code</a';
echo '>';
...
echo '<figure>';
echo '<img';
echo 'src="https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80"';
echo '/>';
echo '</figure>';
echo '</div>';
echo '</div>';
...
echo '</div>';
echo '</section>';
echo '<section id="message-section" class="section is-small">';
echo '<div class="footer mt-4">';
echo '<h3 class="title has-text-centered">Have a Question?</h3>';
echo '<div class="is-flex is-justify-content-center">';
echo '<form';
echo 'action="https://formsubmit.co/61e02830946b2bec555f6d91f539eb4b"';
echo 'id="contact-form"';
echo 'class="mx-6"';
echo 'method="POST"';
echo '>';
echo '<div class="field">';
echo '<label class="label has-text-centered" for="your-name"';
echo '>Your Name</label';
echo '>';
echo '<div class="control">';
echo '<input';
echo 'class="input is-rounded"';
echo 'type="text"';
echo 'id="your-name"';
echo 'name="your-name"';
echo 'required';
...
echo '</div>';
echo '<div class="field">';
echo '<label class="label has-text-centered" for="email"';
echo '>Your Email</label';
echo '>';
echo '<div class="control">';
echo '<input';
echo 'class="input is-rounded"';
...
echo '</div>';
echo '<div class="field">';
echo '<label class="label has-text-centered" for="message"';
echo '>Message</label';
echo '>';
echo '<div class="control">';
echo '<textarea';
echo 'class="textarea"';
echo 'placeholder="Your Message"';
echo 'name="message"';
echo 'id="message"';
echo 'required';
echo '></textarea>';
...
echo '<div class="control">';
echo '<button';
echo 'class="button is-rounded is-fullwidth p-5"';
echo 'id="submit-button"';
echo '>';
echo 'Submit Message';
echo '</button>';
echo '</div>';
...
echo '</section>';
echo '</main>';
echo '<footer class="has-text-centered is-flex is-justify-content-center is-align-items-center p-5">';
echo '';
echo 'Copyright &copy 2022 Justin Flanagan';
echo '';
echo '</footer>';
echo '</body>';
echo '</html>';
