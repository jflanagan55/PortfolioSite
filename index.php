...
<html lang="en">
  ...
  <body>
    <div id="modal">
      ...
      <div class="is-flex is-flex-direction-column" id="modal-content">
        <a download href="/JustinFlanaganResume (2).docx"  class="modal-links pt-4">
          Resume
        </a>
        <a
          href="https://www.linkedin.com/in/justin-flan"
          target="_blank"
          id="linked-in"
        >
        LinkedIn
        ...
        <a
          href="https://github.com/jflanagan55"
          id="github"
          target="_blank"
        >
        GitHub
        </a>
        <a href="#skills-section" class="modal-links">About</a>
        <a href="#projects-section"class="modal-links">Projects</a>
        <a href="#message-section" class="modal-links pb-4">Contact</span></a>
      </div>
    </div>
    <nav class="p-3">
      <div class="pl-5" id="nav-info">
        <a href="#skills-section" class="pr-2"> <span>About</span></a>
        <a href="#projects-section" class="px-2"> <span>Projects</span></a>
        <a href="#message-section" class="pl-2"> <span>Contact</span></a>
      </div>
      <div>
        <a href="">
        <h2 id="justin-flanagan">Justin Flanagan</h2>
      </a>
      </div>
      <div class="pr-5" id="social">
        <a download href="/JustinFlanaganResume (2).docx" class="pr-2">
          Resume
        </a>
        <a
          href="https://www.linkedin.com/in/justin-flan"
      ...
      <div id="mobile-only">
      <div id="jf" class="pl-4"><a href="">JF</a></div>
      <div id="hamburger" class="pr-4">
    ...
    <section
      id="first-section"
      class="section is-medium is-flex is-align-items-center is-flex-direction-column"
    >
      <div>
        <p>Front End Development & Web Design</p>
        <p>I like to make intuitive UIs</p>
      </div>
    </section>

    <main>
      <section id="skills-section" class="py-6">
        <h2>A Little About Me</h2>
        <h3 class="py-6"><span>Proficiencies</span></h3>
        ...
        <h3 class="py-6"><span>Competencies</span></h3>
        <div class="icon-container">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 48 48"
      ...
      <section id="projects-section" class="section is-medium">
        ...
        <div
          class="is-flex is-align-items-center is-flex-direction-column pt-6" id="projects-container"
        >
          <div class="box">
            <div class="content">
              <div class="is-flex is-justify-content-flex-start">
                <figure>
                  <img
                  src=https://images.unsplash.com/photo-1537047902294-62a40c20a6ae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80
                  />
                </figure>
              </div>
              <div class="is-flex is-justify-content-flex-start">
                ...
                >
                  <h3 class="project-titles">Restaurant Journal</h3>
                  <p class="has-text-centered pb-4">
                    Simple CRUD application with user authentication that stores
                    users reviews of restaurants. Made with Mongoose, Express,
                    and Node.
                  </p>
                  <div class="button-container">
                    <a
                      href="https://justin-flanagan-restaurants.herokuapp.com"
                      class=" button is-rounded"
                      target="_blank"
                      >Live Demo</a
                    >
                    <a
                      href="https://github.com/jflanagan55/Restaurants"
                      class="button is-rounded"
                      target="_blank"
                      >Source Code</a
                    >
            ...
            <div class="content p-2">
              <div class="is-flex is-justify-content-flex-start">
                <div
                  class="is-flex is-flex-direction-column is-justify-content-space-evenly"
                >
                  <h3 class="project-titles">Shoe Store</h3>
                  <p class="has-text-centered pb-4">
                    Mock e-commerce shoe site with interactive cart and checkout
                    form validation. Made with React, Redux, and Semantic UI.
                  </p>
                  <div class="button-container">
                    <a
                      href="https://justin-flanagan-shoe-store.herokuapp.com/"
                      class="button is-rounded"
                      target="_blank"
                      >Live Demo</a
                    >
                    <a
                      href="https://github.com/jflanagan55/eCommerce/"
                      class="button is-rounded"
                      target="_blank"
                      >Source Code</a
                    >
              ...
              <div class="is-flex is-justify-content-flex-end">
                <figure>
                  <img
                    src="https://images.unsplash.com/photo-1603808033192-082d6919d3e1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=715&q=80"
                  />
                </figure>
              </div>
            </div>
          ...
          <div class="box">
            <div class="content">
              <div class="is-flex is-justify-content-flex-start">
                <figure>
                  <img
                  src="https://images.unsplash.com/photo-1587223962930-cb7f31384c19?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                />
                </figure>
              </div>
              <div class="is-flex is-justify-content-flex-start">
                <div
                  class="is-flex is-flex-direction-column is-justify-content-space-evenly"
                >
                  <h3 class="project-titles">Cocktail Finder</h3>
                  <p class="has-text-centered pb-4">
                    User Interface that connects to a cocktail api, takes user
                    input, and displays information about a drink. Made with
                    Javascipt and Bulma.
                  </p>
                  <div class="button-container">
                    <a
                      href="https://justin-flanagan-cocktail.herokuapp.com/index.html"
                      class= "button is-rounded"
                      target="_blank"
                      >Live Demo</a
                    >
                    <a
                      href="https://github.com/jflanagan55/CocktailAPI"
                      class= "button is-rounded"
                      target="_blank"
                      >Source Code</a
                    >
            ...
            <div class="content p-2">
              <div class="is-flex is-justify-content-flex-start">
                <div
                  class="is-flex is-flex-direction-column is-justify-content-space-evenly"
                >
                  <h3 class="project-titles">Previous Site</h3>
                  <p class="has-text-centered pb-4">
                    My first version of my portfolio site. Created using all of the same technologies as this current site.
                  </p>
                  <div class="button-container">
                    <a
                      href="https://first-edition-site.herokuapp.com/"
                      class="button is-rounded"
                      target="_blank"
                      >Live Demo</a
                    >
                    <a
                      href="https://github.com/jflanagan55/FirstEditionSite"
                      class="button is-rounded"
                      target="_blank"
                      >Source Code</a
                    >
      ...
      <section id="message-section" class="section is-small">
        <div class="footer mt-4">
          <h3 class="title has-text-centered">Have a Question?</h3>
          <div class="is-flex is-justify-content-center">
            <form
              action="https://formsubmit.co/61e02830946b2bec555f6d91f539eb4b"
              id="contact-form"
              class="mx-6"
              method="POST"
            >
              <div class="field">
                <label class="label has-text-centered" for="your-name"
                  >Your Name</label
                >
                <div class="control">
                  <input
              ...
              <div class="field">
                <label class="label has-text-centered" for="email"
                  >Your Email</label
                >
                <div class="control">
                  <input
              ...
              <div class="field">
                <label class="label has-text-centered" for="message"
                  >Message</label
                >
                <div class="control">
                  <textarea
              ...
              <div class="control">
                <button
                  class="button is-rounded is-fullwidth p-5"
                  id="submit-button"
                >
                  Submit Message
                </button>
    ...
    <footer class="has-text-centered is-flex is-justify-content-center is-align-items-center p-5">
    
        Copyright &copy 2022 Justin Flanagan
